...
<div class="mb-10">
    ...
    <div class="bg-[rgba(241,241,241,1)] p-10">
        <div class="mb-5">
            ...
            <x-dash-ui-input type="email" name="email" id="email" placeholder="you@example.com"/>
        </div>
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <x-dash-ui-textarea name="address" id="address" placeholder="Enter your address" rows="3"></x-dash-ui-textarea>
        </div>
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <label for="email" class="form-label">Email</label>
            <x-dash-ui-input type="email" name="email" id="email" placeholder="you@example.com" helpText="We’ll use this address if we need to contact you about your account."/>
        </div>
        ...
        <div class="mb-5">
            ...
            <x-dash-ui-input type="text" name="name" id="name" error="Store name is required"/>
            <div class="mt-2">
